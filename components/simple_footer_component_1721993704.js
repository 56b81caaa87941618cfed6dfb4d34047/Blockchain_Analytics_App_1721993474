...
*/
Vue.component("simple_footer_component_1721993704", {
    template: `
            ...
            <div id="footer-container" class="max-w-screen-xl p-4 py-6 mx-auto lg:py-16 md:p-8 lg:p-10">
                ...
                <div class="flex">
                    <div id="footer-text" class="flex-1 block text-sm text-center text-gray-500 dark:text-gray-400">
                        Stay ahead of the curve with BlockScan's real-time blockchain data analysis. Our cutting-edge platform provides in-depth insights into emerging blockchain networks, transactions, and activity. Gain a competitive edge with our advanced analytics tools tailored for developers, researchers, and enterprises.
                    </div>
                </div>
            </div>
        </footer> 
